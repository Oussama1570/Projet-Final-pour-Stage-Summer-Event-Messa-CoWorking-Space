...
export const createRoomController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      error,
      message: "Error in crearing room",
    });
  }
};
...
export const searchRoomController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "Error In Search Room API",
      error,
    });
  }
};
...
export const relatedRoomController = async (req, res) => {
  try {
    ...
    res.status(400).send({
      success: false,
      message: "error while getting related room",
      error,
    });
  }
};
...
export const roomCategoryController = async (req, res) => {
  try {
    ...
    const rooms = await roomModel.find({ category }).populate("category");
    res.status(200).send({
      success: true,
      category,
      rooms,
